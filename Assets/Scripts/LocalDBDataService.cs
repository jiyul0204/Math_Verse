...
public class LocalDBDataService : Singleton<LocalDBDataService>
{
    ...
    private const string FILE_NAME_STUDY_INFO_DATA = "DBInitDataList.csv";
    ...
    private const string FILE_NAME_MULTIPLICATION_TEST = "DBQuestMultiplicationDataList.csv";
    private const string FILE_NAME_DIVISION_TEST = "DBQuestDivisionDataList.csv";
    ...
    private void Start()
    {
        ...
        string questMultiplicationDataListCSV = File.ReadAllText($"{Application.streamingAssetsPath}/{FILE_NAME_MULTIPLICATION_TEST}");
        ...
        string questDivisionDataListCSV = File.ReadAllText($"{Application.streamingAssetsPath}/{FILE_NAME_DIVISION_TEST}");

        GameQuestDivisionList = new List<DBQuestDivisionData>(CSVParser.Deserialize<DBQuestDivisionData>(questDivisionDataListCSV));

        string initDataListCSV = File.ReadAllText($"{Application.streamingAssetsPath}/{FILE_NAME_STUDY_INFO_DATA}");
